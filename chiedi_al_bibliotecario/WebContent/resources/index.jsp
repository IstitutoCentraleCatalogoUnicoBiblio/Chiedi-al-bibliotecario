...
<link rel="stylesheet" type="text/css" href="lib/google_icons/material-icons.css">
...
<script>
	...
	var conf_polo = ${conf_polo};
	var poli_disponibili = ${poli_disponibili};
	
</script>
</head>
<body id="ng-app" ng-app="assistenzaApp" onload="onInactive(1800000, logout);">
	<div ng-view></div>

	<script type="text/javascript" src="lib/jquery-3.3.1.min.js"></script>
	<script type="text/javascript" src="lib/angular/angular.js"></script>
	<script type="text/javascript"
		src="lib/angular/angular-resource.min.js"></script>
		<script type="text/javascript"
		src="lib/Paging.js"></script>
		<script type="text/javascript"
	...
	<script type="text/javascript"
		src="lib/bootstrap-4.0.0-dist/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="js/Application.js"></script>

	<script type="text/javascript"
		src="js/controllers/LoginRegisterController.js"></script>
	<script type="text/javascript" src="js/LocalDataServices.js"></script>
	<script type="text/javascript" src="js/ApiServices.js"></script>
</body>
</html>