 ...
 ******************************************************************************/
package it.almaviva.cms.services.secureData;
...
public class PasswordEncrypter {
	...
	public PasswordEncrypter(String passPhrase) {
		...
		// 8-bytes Salt
		byte[] salt = { (byte) 0xA8, (byte) 0x9B, (byte) 0xC8, (byte) 0x32, (byte) 0x56, (byte) 0x34, (byte) 0xE3,
				(byte) 0x03 };
	...
	private String utf8PasswordToBase64(String passPhrase) {
		...
		try {
			...
			// il charset UTF8 utilizza un singolo byte per i caratteri base
			// ASCII(0x00-0x7F)
